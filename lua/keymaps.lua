...
-- Telescope
map("n", "<leader>ff", [[<Cmd>lua require'telescope.builtin'.find_files({prompt_title =' [ FIND FILES ] '})<CR>]], defaut_opts)
map("n", "<leader>fw", [[<Cmd>lua require'telescope.builtin'.live_grep()<CR>]], defaut_opts)
map("n", "<leader>fp", [[<Cmd>lua require'telescope.builtin'.file_browser({prompt_title =' [ NVIM-TREE CLONE : D] '})<CR>]], defaut_opts)
map("n", "<leader>fc", [[<Cmd>lua require'telescope.builtin'.colorscheme({prompt_title =' [ CHANGE COLORSCHEME ] '})<CR>]], defaut_opts)
map("n", "<leader>fo", [[<Cmd>lua require'telescope.builtin'.oldfiles({prompt_title =' [ GO THOUGH OLDFILES ] '})<CR>]], defaut_opts)
map("n", "<leader>fk", [[<Cmd>lua require'telescope.builtin'.keymaps()<CR>]], defaut_opts)
map("n", "<leader>fm", [[<Cmd>lua require'telescope.builtin'.current_buffer_fuzzy_find({prompt_title =' [ FIND LINE IN CURRENT FILE] '})<CR>]], defaut_opts)
...
-- Harpooon
map('n', '<A-p>', [[<cmd>lua require("harpoon.ui").toggle_quick_menu()<CR>]], defaut_opts)
