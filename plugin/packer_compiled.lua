...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "vim-vsnip", "cmp-npm" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
