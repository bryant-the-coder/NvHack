...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-npm", "cmp-path", "vim-vsnip" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
