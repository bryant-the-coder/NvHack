...
_G.packer_plugins = {
  ...
  ["Sakura.nvim"] = {
    loaded = true,
    path = "C:\\Users\\User\\AppData\\Local\\nvim-data\\site\\pack\\packer\\start\\Sakura.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "vim-vsnip", "cmp-buffer", "cmp-path" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
